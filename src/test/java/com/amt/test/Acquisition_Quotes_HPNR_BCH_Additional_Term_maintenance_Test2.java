...
public class Acquisition_Quotes_HPNR_BCH_Additional_Term_maintenance_Test2 extends TestBase {
	...
	public void aquisition_quotes_HPNR_BCH_holding_cost_calculations_without_maintenance_test(String manufacturer,
		 ...
		 * residual_value_used, percentage_cap_residual_value_used,
	...
	public void aquisition_quotes_HPNR_BCH_customer_quote_payment_profile_calculations_without_maintenance_test(
		 ...
		 * .check_monthly_payments_on_adding_upsell_values_without_maintenance(
		 * security_deposit, matrix_upsell, referrer_upsell, add_terms, add_mileage,
		 * sheet_name);
		 * 
...
//		Assert.assertTrue(cutomer_quote_monthly_rental);
	...
	public void aquisition_quotes_HPNR_BCH_quote_summary_values_verification_without_maintenance_test(
		...
		boolean quote_summary_page_status = obj_quote_summary_page
				.quote_summary_HPNR_BCH_without_maintenance(sheet_name);
	 ...
	 * 
	 * public void
	 * aquisition_quotes_HPNR_BCH_quote_summary_values_verification_without_maintenance_test(
	 * String manufacturer, String model, String road_tax_for_first_year, String
	 * on_road_price_for_invoice, String other_support_value, String
	 * percentage_cap_residual_value_used, String residual_value_used, String
	 * actual_part_exchange_value_from_excel, String
	 * given_part_exchange_value_from_excel, String
	 * less_finance_settlement_from_excel, String order_deposit_from_excel, String
	 * document_fee_from_excel, String security_deposit, String matrix_upsell,
	 * String referrer_upsell, String add_terms, String add_mileage, String
	 * maintenance_required, String maintenance_margin, String initial_payment,
	 * String part_exchange_status, String target_rental, String sheet_name) throws
	 ...
	 * .quote_summary_configuration_value_verification_without_maintenance(
	 * sheet_name); Assert.assertTrue(quote_summary_configuration_value_check);
	 * 
	 * System.out.println(""); System.out.println("");
	 * 
	 ...
	 * .quote_summary_customer_quote_summary_value_verification_without_maintenance(
	 * sheet_name); Assert.assertTrue(quote_summary_customer_quote_calculation1);
	 * 
	 * System.out.println(""); System.out.println("");
	 * 
	 * boolean quote_summary_configuration_value_check1 = obj_quote_summary_page
	 * .quote_summary_configuration_value_verification_without_maintenance(
	 * sheet_name); Assert.assertTrue(quote_summary_configuration_value_check1);
	 * 
	 * System.out.println(""); System.out.println("");
	 * 
