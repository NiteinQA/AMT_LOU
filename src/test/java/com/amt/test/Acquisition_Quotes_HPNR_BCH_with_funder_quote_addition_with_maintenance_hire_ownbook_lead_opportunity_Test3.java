...
public class Acquisition_Quotes_HPNR_BCH_with_funder_quote_addition_with_maintenance_hire_ownbook_lead_opportunity_Test3 extends TestBase {
	...
	public void aquisition_quotes_HPNR_BCH_holding_cost_calculations_with_maintenance_test(String manufacturer,
	  ...
	  String manufacturer, String model, String quoteRef, String expiryDate, String
	  term, String milesPerAnnum, String cashDeposit, String financeCharges, String
	  documentFee, String monthlyPayment, String finalBallonPayment, String
	  ...
	  boolean balance_due_value =
	  obj_customer_quote_page.customer_quote_part_balance_due_value_verification(
	  actual_part_exchange_value_from_excel, given_part_exchange_value_from_excel,
	  less_finance_settlement_from_excel, order_deposit_from_excel,
	  document_fee_from_excel, upsell, part_exchange_status, target_rental,
	  sheet_name);
	...
	public void aquisition_quotes_HPNR_BCH_quote_summary_values_verification_with_maintenance_test(String manufacturer,
		...
		obj_quote_summary_page.quote_summary_HPNR_BCH_with_maintenance(sheet_name);
		 ...
		 * .quote_summary_holding_cost_calculation_with_maintenance_for_funder(
		 * sheet_name); Assert.assertTrue(quote_summary_holding_cost_calculation);
		 * 
		 ...
		 * quote_summary_edit_maintenance_margin_value_verification_for_funder(
		 * sheet_name); Assert.assertTrue(value_check_after_maint_margin_change);
		 */
