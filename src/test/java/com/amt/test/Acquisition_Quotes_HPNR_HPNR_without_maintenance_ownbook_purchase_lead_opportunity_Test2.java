...
public class Acquisition_Quotes_HPNR_HPNR_without_maintenance_ownbook_purchase_lead_opportunity_Test2 extends TestBase {
	...
	public void aquisition_quotes_HPNR_HPNR_holding_cost_calculations_without_maintenance_test(String manufacturer, String model
		...
		/*
		 * boolean holding_cost_without_maintenance_boolean =
		 * obj_holding_cost_HPNR_HPNR_page
		...
		/*
		 * boolean holding_cost_after_editing_percentage_value =
		 * obj_holding_cost_HPNR_HPNR_page
		 * .edit_percentage_residual_verify_holding_cost_without_maintenance(
		 * residual_value_used, percentage_cap_residual_value, maintenance_status,
		 * sheet_name); Assert.assertTrue(holding_cost_after_editing_percentage_value);
		 * 
		 * boolean holding_cost_after_editing_residual_value =
		 * obj_holding_cost_HPNR_HPNR_page
		 * .edit_residual_value_used_then_verify_holding_cost_without_maintenance(
		 * residual_value_used, percentage_cap_residual_value, maintenance_status,
		 * sheet_name); Assert.assertTrue(holding_cost_after_editing_residual_value);
		 */
		
		boolean holding_cost_after_editing_additional_terms_and_mileage = obj_holding_cost_HPNR_HPNR_page
	 ...
	 * (String manufacturer, String model , String Vehicle_Basic_price, String
	 * road_tax_for_first_year, String percentage_cap_residual_value, String
	 * residual_value_used, String additional_terms, String additional_mileage,
	 * String vehicle_profit ,String maintenance_status, String matrix_credit_type,
	 * String security_deposit, String balloon_payment_status, String
	 * part_exchange_actual, String part_exchange_given, String
	 * less_finance_settlement, String order_deposit, String finance_deposit, String
	 * document_fee, String sheet_name) throws InterruptedException, IOException,
	 ...
	 * 
	 * 
	 * boolean monthly_finance_payment_after_editing_vehicle_profit
	 * =obj_customer_quote_page.
	 * edit_vehicle_profit_and_check_monthly_finance_payment(vehicle_profit,
	 * sheet_name);
	 ...
	 * put_part_exchange_values_and_check_monthly_finance_payment(
	 * part_exchange_actual, part_exchange_given, less_finance_settlement,
	 * order_deposit, finance_deposit, sheet_name);
	...
	@Test(priority=8, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_HPNR_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test" })
