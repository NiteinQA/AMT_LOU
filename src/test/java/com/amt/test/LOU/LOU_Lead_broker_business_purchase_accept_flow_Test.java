...
public class LOU_Lead_broker_business_purchase_accept_flow_Test extends TestBase {
...
//		// Getting oppo ID and Saving to excel sheet and printing to console
	...
	public void L4_verify_current_status_on_opportunity_page_before_sending_to_proposal_for_broker_business_flow()
			throws Exception {
		obj_Opportunities_Page = new Opportunities();
	...
	@Test(priority = 5 , dependsOnMethods = { "L4_verify_current_status_on_opportunity_page_before_sending_to_proposal_for_broker_business_flow" })
	...
	@Test(priority = 6 , dependsOnMethods = { "L5_adding_proposal_on_opportunity_page_broker_business_flow" })

	public void L6_verify_current_status_on_opportunity_page_after_sending_to_proposal_for_broker_business_flow()
			throws Exception {
		obj_Opportunities_Page = new Opportunities();
	...
	@Test(priority = 7, dependsOnMethods = { "L6_verify_current_status_on_opportunity_page_after_sending_to_proposal_for_broker_business_flow" })

	public void L7_broker_create_opportunity_business_sending_to_contract() throws Exception {
	...
	@Test(priority = 8 , dependsOnMethods = { "L7_broker_create_opportunity_business_sending_to_contract" })

	public void L8_verify_current_status_on_opportunity_page_after_sending_contract_for_broker_business_flow()
			throws Exception {
	...
	@Test(priority = 9 , dependsOnMethods = { "L8_verify_current_status_on_opportunity_page_after_sending_contract_for_broker_business_flow" })
