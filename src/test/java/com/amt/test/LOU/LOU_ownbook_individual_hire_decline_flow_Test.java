...
public class LOU_ownbook_individual_hire_decline_flow_Test extends TestBase {
	...
	public void UW5_verify_ownbook_underwriting_proposal_decision_with_decline() throws Exception {
		...
		// Assert for decline condition
		boolean statusofdecline = obj_Underwriting_page.verify_current_status_of_underwriting_after_sending_to_decline();
		Assert.assertTrue(statusofdecline);
		
		System.out.println("Underwriting Status Verified : declined");
		LO.print          ("Underwriting Status Verified : declined");
