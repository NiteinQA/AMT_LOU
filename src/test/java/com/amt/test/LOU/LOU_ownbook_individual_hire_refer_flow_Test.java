...
public class LOU_ownbook_individual_hire_refer_flow_Test extends TestBase {
	...
	public void L4_verify_current_status_on_opportunity_page_before_sending_to_proposal_for_ownbook_individual_flow()
			throws Exception {
	...
	@Test(priority = 5, dependsOnMethods = {
			"L4_verify_current_status_on_opportunity_page_before_sending_to_proposal_for_ownbook_individual_flow" })

	public void L5_ownbook_create_opportunity_individual_current_status_after_sending_to_proposal() throws Exception {
	...
	@Test(priority = 6, dependsOnMethods = {
			"L5_ownbook_create_opportunity_individual_current_status_after_sending_to_proposal" })
	...
	@Test(priority = 8, dependsOnMethods = {"L7_verify_current_status_on_opportunity_page_after_sending_contract_for_ownbook_individual_flow" })
	...
	public void UW2_verify_underwriting_pop_up_summary_values_for_ownbook_individual_flow() throws Exception {
	...
	@Test(priority = 11 , dependsOnMethods = {"UW2_verify_underwriting_pop_up_summary_values_for_ownbook_individual_flow" })
	...
	public void UW4_verify_values_on_underwriting_quote_tab_for_ownbook_individual_flow() throws Exception {
	...
	@Test(priority = 14, dependsOnMethods = {"UW4_verify_values_on_underwriting_quote_tab_for_ownbook_individual_flow" })

	public void UW5_verify_ownbook_underwriting_proposal_decision_with_refer() throws Exception {
...
//		 obj_Underwriting_page.verification_underwriting_tab_decision_page_view_icon();
		...
		System.out.println("Underwriting Status Verified : referred");
		LO.print          ("Underwriting Status Verified : referred");
	 ...
	 * 
	 * public void
	 * UW7_verify_ownbook_underwriting_proposal_decision_refer_with_changes
	 * ()throws Exception {
	 * 
	 * obj_Underwriting_page = new Underwriting();
	 * 
	 ...
	 * //obj_Underwriting_page.find_underwriting_tab_decision_page();
	 * obj_Underwriting_page.find_underwriting_tab_decision_page_refer_button();
	 * obj_Underwriting_page.ownbook_refer_with_change_the_data_quote();
	 * 
	 * 
	 ...
	 * 
	 * 
	 * // Assert for refer condition boolean statusofrefer =
	 * obj_Underwriting_page.
	 * verify_current_status_of_underwriting_after_sending_to_refer_with_changes();
	 * Assert.assertTrue(statusofrefer);
	 * 
	 * }
	 */

//	@Test(priority = 15 , dependsOnMethods = {"UW5_verify_ownbook_underwriting_proposal_decision_with_refer" } )
//
...
//		obj_Underwriting_Popup_Page.search_and_verify_underwriting_icon_is_availabale();
//
//		// obj_Underwriting_Popup_Page.verify_ownbook_underwriting_popup_refer_with_change_flow();
//
//	}
}
