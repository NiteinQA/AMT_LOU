...
public class LOU_ownbook_individual_purchase_accept_without_any_changes_Test extends TestBase {
	...
	public void UW3_verify_underwriting_lisitig_page() throws Exception {
	  ...
	  public void UW4_verify_ownbook_underwriting_proposal_page_flow() throws Exception {
		...
		boolean quote_tab_status = obj_Underwriting_page.verify_quote_tab_on_underwriting_page_for_ownbook_individual_purchase_flow();
    ...
    obj_Underwriting_page.verification_underwriting_tab_decision_page_save_and_exit_button();
	 ...
	 obj_Underwriting_page.verify_current_status_of_underwriting_after_sending_to_accept();
	  Assert.assertTrue(statusofaccept);
		...
		System.out.println("Status Verified : Accepted ");
		LO.print          ("Status Verified : Accepted ");
