...
public class LOU_used_car_broker_individual_purchase_accept_flow_Test extends TestBase {
...
//		// Getting oppo ID and Saving to excel sheet and printing to console
	...
	public void UW4_verify_underwriting_proposal_page_flow() throws Exception {
		...
		boolean status = obj_Underwriting_page.verify_quote_tab_on_underwriting_page_for_used_car_broker_individual_purchase_flow();
