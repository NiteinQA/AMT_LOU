...
public class LOU_used_car_ownbook_business_hire_accept_without_any_changes_Test extends TestBase {
 ...
 @Test(priority = 14, dependsOnMethods = {"UW4_verify_values_on_underwriting_quote_tab_for_ownbook_business_flow" })
		  ...
		  public void UW5_ownbook_underwriting_decision_accept_without_any_changes ()throws Exception {
