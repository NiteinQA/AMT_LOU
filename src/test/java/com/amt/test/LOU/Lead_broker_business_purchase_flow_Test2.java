...
public class Lead_broker_business_purchase_flow_Test2 extends TestBase {
...
//		obj_Opportunities_Page.opp_verify_channel_data();
	...
	public void UW1_verify_underwriting_flow_ownbook_with_status() throws Exception {
		...
		boolean underwriting_pop_up_value_verification = obj_Underwriting_Popup_Page.verify_underwriting_pop_up_summary_values_for_broker_purchase_flow();
	...
	public void UW4_verify_ownbook_underwriting_proposal_page_flow() throws Exception {
		...
		boolean status = obj_Underwriting_page.verify_quote_tab_on_underwriting_page_for_broker_purchase_flow();
