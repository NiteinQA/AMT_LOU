...
public class Lead_ownbook_business_flow_edit_ownbook_hire_accept_flow_test3 extends TestBase {
	...
	public void L1_ownbook_create_lead_business() throws Exception {
		 ...
		 //Business = HPNR + HPNR
		 obj_Leads_Page.lead_map_new_quote_owbook_hire_business();
		...
		public void UW1_verify_underwriting_flow_ownbook_with_status() throws Exception {
			...
			obj_Underwriting_Popup_Page.search_and_verify_ownbook_hire_underwriting_get_proposal_id();
		...
		public void UW3_verify_underwriting_lisitig_page() throws Exception {
			...
			obj_Underwriting_page.verify_underwriting_proposal_ownbook_hire_search_text_box();
 ...
 @Test(priority = 13)
		  ...
		  //obj_Underwriting_page.find_underwriting_tab_decision_page();
		  obj_Underwriting_page.find_underwriting_tab_decision_page_accept_button();
		  obj_Underwriting_page.ownbook_hire_accept_with_change_the_data_quote();
 ...
 obj_Opportunities_Page.verify_opportunity_ownbook_quote_hire_search_text_box();
 ...
 
 {
	...
	public void OP1_verify_underwriting_flow_ownbook_after_contract_signed_with_latest_changes_() throws Exception {
		...
		obj_Underwriting_Popup_Page.search_and_verify_underwriting_pop_up_close_button();
	...
	@Test(priority = 20)
	public void UW9B_ownbook_after_Underwriting_accepted_mothlty_payment_price() throws Exception

	{

		obj_Opportunities_Page = new Opportunities();

		String[] DataValue1 = obj_Opportunities_Page.get_new_quote_price_after_underwriting_accepted();

		
		
	
		
		String Quoteref_web_1 = DataValue1[0];
		String MonthlyPayment_web_1 = DataValue1[1];
		...
		System.out.println("New Monthly Payment value is  = " + MonthlyPayment_web_1);
		
		
		
		System.out.println(" Cancelled Quote ref value is  =" + QuoteCancelled_web_1);
		System.out.println("Cancelled Mothly Payment value is  = " + MonthlyPayment_cancelled_1);
