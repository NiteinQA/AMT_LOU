...
public class Lead_ownbook_purchase_business_accept_without_any_changes_Test extends TestBase {
 ...
 @Test(priority = 13)
		  ...
		  public void UW5_verify_ownbook_underwriting_proposal_decision_direct_accept ()throws Exception {
 ...
 obj_Opportunities_Page.verify_opportunity_ownbook_purchase_quote_search_text_box();
	 ...
	 * 
	 * public void
	 * UW7_verify_ownbook_oppoortunity_accept_with_changes_underwriting_pop_up
	 * ()throws Exception
	 * 
	 * { obj_Underwriting_Popup_Page = new UnderwritingPopupPage();
	 * 
